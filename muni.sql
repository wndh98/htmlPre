...
CREATE TABLE MUNI_USER(
    ...
    USER_BIRTHDAY DATE,
    USER_COM_NAME VARCHAR2(255),
    USER_COM_NUM VARCHAR2(50),
    USER_CO_NUM VARCHAR2(50),
...
CREATE TABLE PRODUCT_CATE(
    PC_ID NUMBER GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE "PRODUCT_ITEM" (
	...
	"PI_SAIL"       NUMBER(1)     NOT NULL, -- 상품할인
	...
	"PI_CONTENT"    TEXT          NOT NULL, -- 상세정보
	"PI_STATUS"     NUMBER(1)     NOT NULL, -- 상품활성화
	"PI_HIT"        NUMBER(1)     NOT NULL, -- 상품히트
	"PI_COLOR"      NUMBER(1)     NULL,     -- 상품 색상 별도
	"PI_SIZE"       NUMBER(1)     NULL,     -- 상품 사이즈 별도
...
CREATE TABLE PRODUCT_OPTION(
    PO_NUM VARCHAR2(10) NOT NULL,
    PI_NUM NUMBER NOT NULL,
    PO_NAME VARCHAR2(255) NOT NULL,
    PO_PRICE NUMBER,
    PO_SAIL NUMBER(1),
    PO_SAIL_PRICE NUMBER,
    PO_COUNT NUMBER,
    PO_POINT NUMBER,
    CONSTRAINT PK_PO_NUM PRIMARY KEY(PO_NUM),
    CONSTRAINT FK_PO_PI_NUM FOREIGN KEY(PI_NUM) REFERENCES PRODUCT_ITEM(PI_NUM)
);
...
CREATE TABLE ORDER_CART(
    ...
    CONSTRAINT FK_OC_PO_NUM FOREIGN KEY(PO_NUM) REFERENCES PRODUCT_OPTION(PO_NUM)
);
...
CREATE TABLE ORDER_PRODUCT_LIST(
    ...
    CONSTRAINT FK_OPL_PO_NUM FOREIGN KEY(PO_NUM) REFERENCES PRODUCT_OPTION(PO_NUM)
);
